...
void Timer0Class::setClockSource(Timer0ClockSource clockSource) {
#if defined(TCCR0B)
    TCCR0B = (uint8_t) ((TCCR0B & TIMER0_CLOCK_MASK) | clockSource);
#elif defined(TCCR0)
    TCCR0 = (uint8_t) ((TCCR0 & TIMER0_CLOCK_MASK) | clockSource);
#endif
}
